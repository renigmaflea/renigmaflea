...
class HHACategoriesCard extends React.Component {
    ...
    return (
        <Card centered>
          ...
          <Card.Content textAlign='center' extra style={{ fontSize: '20px' }}>
            <Link to='/listhha'> {/* change to link of categories */}
...
export default withRouter(HHACategoriesCard);
