...
class ServersCategoriesCard extends React.Component {
    ...
    return (
        <Card centered>
          ...
          <Card.Content textAlign='center' extra style={{ fontSize: '20px' }}>
            <Link to='/listservers'> {/* change to link of categories */}
...
ServersCategoriesCard.propTypes = {
...
export default withRouter(ServersCategoriesCard);
