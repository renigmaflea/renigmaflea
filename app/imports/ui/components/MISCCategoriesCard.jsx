...
class MISCCategoriesCard extends React.Component {
    ...
    return (
        <Card centered>
          ...
          <Card.Content textAlign='center' extra style={{ fontSize: '20px' }}>
            <Link to='/listmisc'> {/* change to link of categories */}
...
export default withRouter(MISCCategoriesCard);
