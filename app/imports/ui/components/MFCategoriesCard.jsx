...
class MFCategoriesCard extends React.Component {
    ...
    return (
        <Card centered>
          ...
          <Card.Content textAlign='center' extra style={{ fontSize: '20px' }}>
            <Link to='/listmf'> {/* change to link of categories */}
...
export default withRouter(MFCategoriesCard);
